...
export function MoodTab({ initialMoodIconPack }: MoodTabProps) {
  ...
  return (
    <>
      ...
      <div id="mood-activities" className="bg-white/60 dark:bg-gray-900/60 rounded-2xl border border-white/40 dark:border-gray-700/40 shadow-sm shadow-black/3 p-6 space-y-4">
