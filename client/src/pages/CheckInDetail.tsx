...
export default function CheckInDetail() {
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
      ...
      {/* Map */}
      {hasCoords && (
        <div className="page-map-breakout bg-white/60 dark:bg-gray-900/60 rounded-2xl border border-white/40 dark:border-gray-700/40 shadow-sm shadow-black/3 overflow-hidden">
          <MapView
