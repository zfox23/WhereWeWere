...
export function TimestampLink({ to, checkedInAt, timezone, mode = 'full', classNameOverride }: TimestampLinkProps) {
  return (
    <div className={`flex items-center gap-1.5 flex-wrap ${classNameOverride ?? 'mt-4'}`}>
      <Link
        to={to}
