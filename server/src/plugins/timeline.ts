...
export const TIMELINE_COLUMNS: TimelineColumn[] = [
  ...
  { name: 'venue_id', nullSql: `NULL AS venue_id` },
  ...
  { name: 'venue_name', nullSql: `NULL AS venue_name` },
  { name: 'venue_latitude', nullSql: `NULL AS venue_latitude` },
  { name: 'venue_longitude', nullSql: `NULL AS venue_longitude` },
  { name: 'venue_timezone', nullSql: `NULL::text AS venue_timezone` },
  { name: 'venue_category', nullSql: `NULL AS venue_category` },
  { name: 'parent_venue_id', nullSql: `NULL AS parent_venue_id` },
  { name: 'parent_venue_name', nullSql: `NULL AS parent_venue_name` },
