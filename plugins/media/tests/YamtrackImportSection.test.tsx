...
const previewFixture = {
  ...
  plans: [
    ...
    { line: 6, media_id: '4', source: 'igdb', media_type: 'game', title: 'Hades', season_number: null, episode_number: null, status: 'In progress', score: '9', start_date: null, end_date: null, checked_in_at: null, disposition: 'update_game_item', reason: '', checkin_type: null, rating: 4, raw_score: 9, time_played_minutes: 326, duplicate_of_line: null },
  ],
} as any;
